            ...
            <form action="{{ route('visitas.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <table class="table">
                    <thead class="thead-dark">
                        ...
                        <a class="btn btn-info" href="{{ route('visitantes.create') }}"><svg
                                xmlns="http://www.w3.org/2000/svg" width="13" height="16" fill="currentColor"
                    ...
                    <tr>
                        <th scope="row">
                            <div class="form-group">
                                ...
                                <input type="date" name="data_entrada" class="form-control" placeholder="">
                            </div>

                        <th scope="row">
                            <div class="form-group">
                                <strong>Hora entrada:</strong>
                                <input type="time" name="hora_entrada" class="form-control" placeholder="">
                            </div>
                        <td>
                            <div class="form-group">
                    ...
                    <tr>
                        <th scope="row">
                            <div class="form-group">
                                ...
                                <input type="date" name="data_saida" class="form-control" placeholder="">
                            </div>
                        <th scope="row">
                            <div class="form-group">
